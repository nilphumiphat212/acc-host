...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1536: x0 => x0.abort(),
      _1537: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1538: (x0,x1) => globalThis.fetch(x0,x1),
      _1539: (x0,x1) => x0.get(x1),
      _1540: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._1540(f,arguments.length,x0,x1,x2) }),
      _1541: (x0,x1) => x0.forEach(x1),
      _1542: x0 => x0.getReader(),
      _1543: x0 => x0.cancel(),
      _1544: x0 => x0.read(),
